...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        public static void AllClickModeToDisabled()
        {
            AllClickModeTo(ClickMode.Disabled);
        }

        public static void AllClickModeTo(ClickMode clickMode)
        {
            var allInputs = FindObjectsOfType<DialogInput>(true);
            foreach (var inputEl in allInputs)
            {
                inputEl.ClickMode = clickMode;
            }
        }
        ...
        public static void AllClickModeToClickAnywhere()
        {
            AllClickModeTo(ClickMode.ClickAnywhere);
        }

        public static void AllClickModeToClickOnDialog()
        {
            AllClickModeTo(ClickMode.ClickOnDialog);
        }

        public static void AllClickModeToClickOnButton()
        {
            AllClickModeTo(ClickMode.ClickOnButton);
        }
        /// <summary>
